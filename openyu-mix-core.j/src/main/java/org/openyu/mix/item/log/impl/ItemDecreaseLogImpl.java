...
@Table(name = "mix_item_decrease_log")
@SequenceGenerator(name = "mix_item_decrease_log_g", sequenceName = "mix_item_decrease_log_s", allocationSize = 1)
//when use ehcache, config in ehcache.xml
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "org.openyu.mix.item.log.impl.ItemDecreaseLogImpl")
@Proxy(lazy = false)
@org.hibernate.annotations.Table(appliesTo = "mix_item_decrease_log", indexes = { @org.hibernate.annotations.Index(name = "idx_mix_item_decrease_log_1", columnNames = {
...
public class ItemDecreaseLogImpl extends ItemLogSupporter implements ItemDecreaseLog
{
	...
	@Id
	@Column(name = "seq")
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "mix_item_decrease_log_g")
	public Long getSeq()
	{
		return seq;
	}
