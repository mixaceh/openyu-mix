...
@DynamicInsert
@DynamicUpdate
@Table(name = "sasang_play_log", indexes = {
		@Index(name = "sasang_play_log_role_id_log_date_play_type", columnList = "role_id,log_date,play_type") })
@SequenceGenerator(name = "sg_sasang_play_log", sequenceName = "seq_sasang_play_log", allocationSize = 1)
...
public class SasangPlayLogImpl extends AppLogEntitySupporter implements SasangPlayLog {
	...
	@Id
	@Column(name = "seq")
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "sg_sasang_play_log")
	public Long getSeq() {
		return seq;
	}
