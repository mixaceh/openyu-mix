...
@Table(name = "mix_account")
@SequenceGenerator(name = "mix_account_g", sequenceName = "mix_account_s", allocationSize = 1)
//when use ehcache, config in ehcache.xml
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "org.openyu.mix.account.po.impl.AccountPoImpl")
@Proxy(lazy = false)
@org.hibernate.annotations.Table(appliesTo = "mix_account", indexes = { @org.hibernate.annotations.Index(name = "idx_mix_account_1", columnNames = {
		"valid", "id" }) })
//--------------------------------------------------
//search
//--------------------------------------------------
...
public class AccountPoImpl extends SeqIdAuditNamesEntitySupporter implements AccountPo
{
	...
	@Id
	@Column(name = "seq")
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "mix_account_g")
	public Long getSeq()
	{
		return seq;
	}
	...
	//	@OneToMany(targetEntity = RolePoImpl.class, mappedBy = "account", cascade = CascadeType.ALL)
