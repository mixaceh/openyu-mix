 ...
 * 請求攔截器
 */
public class DebugRequestInterceptor extends AppMethodInterceptorSupporter {

	private static transient final Logger LOGGER = LoggerFactory.getLogger(DebugRequestInterceptor.class);
