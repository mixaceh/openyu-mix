package org.openyu.mix.treasure.service.adapter;
 ...
 * field改變監聽器
 */
public class TreasureChangeAdapter extends BeanChangeAdapter {

	private static transient final Logger LOGGER = LoggerFactory
			.getLogger(TreasureChangeAdapter.class);

	@Autowired
	@Qualifier("treasureService")
	protected transient TreasureService treasureService;

	public TreasureChangeAdapter() {
	}
