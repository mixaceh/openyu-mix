...
@Table(name = "mix_wuxing_famous_log")
@SequenceGenerator(name = "mix_wuxing_famous_log_g", sequenceName = "mix_wuxing_famous_log_s", allocationSize = 1)
//when use ehcache, config in ehcache.xml
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "org.openyu.mix.wuxing.log.impl.WuxingFamousLogImpl")
@Proxy(lazy = false)
@org.hibernate.annotations.Table(appliesTo = "mix_wuxing_famous_log", indexes = { @org.hibernate.annotations.Index(name = "idx_mix_wuxing_famous_log_1", columnNames = {
...
public class WuxingFamousLogImpl extends AppLogEntitySupporter implements WuxingFamousLog
{
	...
	@Id
	@Column(name = "seq")
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "mix_wuxing_famous_log_g")
	public Long getSeq()
	{
		return seq;
	}
